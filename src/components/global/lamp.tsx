    ...
    return (
        <LampContainer>
           <motion.h1
                ...
                className="mt-20 bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-7xl bricolage font-bold tracking-tight text-transparent md:text-9xl"
            >
                I'm Om
                <br /> Raval
            </motion.h1>
    ...
    return (
        ...
        >
            <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
                ...
                <div className="absolute inset-auto z-40 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-neutral-500 opacity-50 blur-3xl"></div>
                <motion.div
                    initial={{ width: "8rem" }}
                ...
                <motion.div
                    ...
                    className="absolute inset-auto z-40 h-0.5 w-[30rem] -translate-y-[7rem] bg-neutral-400 "
                ></motion.div>
